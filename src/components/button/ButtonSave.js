...
const ButtonArea = ({ todo, setTodo }) => {
  ...
  return (
    <View style={styles.view}>
      <TextInput placeholder="Todo's" style={styles.text_input} value={todoValue} onChangeText={setTodoValue} />
      <Separator></Separator>
      <View style={styles.button}>
        <Button title='Save' color="#4C68A3" onPress={()=>handleSubmit(todoValue)}></Button>
      </View>
    </View>
  );
};
